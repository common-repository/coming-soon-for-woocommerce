=== Coming Soon Badge for WooCommerce ===
...
3. Or download, unzip and upload through FTP to the /wp-content/plugins/ directory. Then go to admin plugins page and activate it.
...
3. Edit any product where you want to show the badge, and activate the checkbox labeled "Show Coming Soon badge" under the publication product date.
...
= The badge preview is not exactly equal as badge on front-end =
